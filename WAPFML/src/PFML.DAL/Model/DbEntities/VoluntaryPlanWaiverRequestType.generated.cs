...
namespace PFML.DAL.Model.DbEntities
{
    ...
    public class VoluntaryPlanWaiverRequestType : BaseEntity
    {
        ...
        internal static void ModelCreating(DbModelBuilder builder)
        {
            ...
            builder.Entity<VoluntaryPlanWaiverRequestType>().Property(x => x.PercentagePaid).HasPrecision(3, 2);
            ...
            builder.Entity<VoluntaryPlanWaiverRequestType>().HasRequired(x => x.VoluntaryPlanWaiverRequest).WithMany(x => x.VoluntaryPlanWaiverRequestTypes).HasForeignKey(x => x.VoluntaryPlanWaiverRequestId);
        }
        ...
        public VoluntaryPlanWaiverRequestTypeDto ToDto(VoluntaryPlanWaiverRequestTypeDto dto = null)
        {
            ...
            dto.VoluntaryPlanWaiverRequestTypeId = VoluntaryPlanWaiverRequestTypeId;
