...
namespace PFML.Web.ServiceProxies.Premium.Waiver.VPRequest
{
    ...
    public static class VPRequestProxy
    {
        ...
        public static System.Collections.Generic.List<PFML.Shared.ViewModels.Premium.Waiver.VPRequestViewModel> GetList(int EmployerId)
        {
        ...
        ///<summary>ASYNC Web Service call: unknown</summary>
        ///<returns>ASYNC task: unknown</returns>
        public static async Task<System.Collections.Generic.List<PFML.Shared.ViewModels.Premium.Waiver.VPRequestViewModel>> GetRequestAsync(int RequestId)
        {
        ...
        ///<summary>Web Service call: unknown</summary>
        public static System.Collections.Generic.List<PFML.Shared.ViewModels.Premium.Waiver.VPRequestViewModel> GetRequest(int RequestId)
        {
        ...
        ///<summary>Web Service call: unknown</summary>
        public static System.Collections.Generic.List<PFML.Shared.ViewModels.Premium.Waiver.VPRequestViewModel> SubmitRequest(PFML.Shared.ViewModels.Premium.Waiver.VPRequestForm VPRequestForm)
        {
